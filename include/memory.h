...
void *memmove(void *dst, const void *src, ulen count);
void *memmove_c(void *dst, ulen max, const void *src, ulen count);
i16 memcmp(const void *lhs, const void *rhs, ulen count);
bool memeq(const void *lhs, const void *rhs, ulen count);
const void *memchr(const void *ptr, u8 chr, ulen count);
